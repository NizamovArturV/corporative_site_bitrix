...
<?$APPLICATION->IncludeComponent(
    ...
    Array(
        ...
        "DETAIL_FIELD_CODE" => array("DATE_ACTIVE_FROM", "PREVIEW_PICTURE"),
        "DETAIL_PAGER_SHOW_ALL" => "Y",
        "DETAIL_PAGER_TEMPLATE" => "",
        "DETAIL_PAGER_TITLE" => "Страница",
        "DETAIL_PROPERTY_CODE" => array("SCHOOL", "DIRECTION"),
        ...
        "LIST_PROPERTY_CODE" => array("SCHOOL", "DIRECTION"),
        "MESSAGE_404" => "",
        "META_DESCRIPTION" => "-",
        "META_KEYWORDS" => "-",
        "NEWS_COUNT" => "24",
        ...
        "SET_TITLE" => "Y",
        "SHOW_404" => "N",
        "SORT_BY1" => isset($_GET['SORT_BY']) && $_GET['SORT_BY'] !== '' ? $_GET['SORT_BY'] : 'SHOW_COUNTER',
        "SORT_BY2" => "SORT",
        "SORT_ORDER1" => isset($_GET['SORT_ORDER']) && $_GET['SORT_ORDER'] !== '' ? $_GET['SORT_ORDER'] : 'DESC',
        "SORT_ORDER2" => "ASC",
