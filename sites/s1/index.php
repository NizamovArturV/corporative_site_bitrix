...
<? $APPLICATION->IncludeComponent(
    ...
    <section class="directions-professions wow fadeInUp">
    <div class="container">
        <? $GLOBALS['popularDirection']['PROPERTY_POPULAR_VALUE'] = 'Y'?>
<?$APPLICATION->IncludeComponent("bitrix:news.list", "directions_index", Array(
    "ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
    "ADD_SECTIONS_CHAIN" => "N",	// Включать раздел в цепочку навигации
    "AJAX_MODE" => "N",	// Включить режим AJAX
    "AJAX_OPTION_ADDITIONAL" => "",	// Дополнительный идентификатор
    ...
    "STRICT_SECTION_CHECK" => "N",	// Строгая проверка раздела для показа списка
        ...
        <?$APPLICATION->IncludeComponent("bitrix:news.list", "proffesions_index", Array(
            "ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
            "ADD_SECTIONS_CHAIN" => "N",	// Включать раздел в цепочку навигации
            "AJAX_MODE" => "N",	// Включить режим AJAX
            "AJAX_OPTION_ADDITIONAL" => "",	// Дополнительный идентификатор
...
<?$APPLICATION->IncludeComponent("bitrix:news.list", "good_to_know_index", Array(
