...
//            $APPLICATION->SetTitle('Полезно знать - ' .  $ar_result['NAME']);
            $APPLICATION->SetPageProperty("keywords", $ar_result['UF_KEYWORDS']);
            $APPLICATION->SetPageProperty("description", $ar_result['UF_SEO_DESCRIPTION']);
...
?>
<script>
    window.history.pushState("object or string", "Title", "<?=$strPage?>");
</script>
<section class="news">
    <div class="container">
        <div class="big-block__wrap">
            ...
            <ul class="big-block__selector selector-mobile">
                <? foreach ($sections as $SECTION):?>
                    <li><a href="<?=$SECTION['SECTION_PAGE_URL']?>" class="big-block__selector-item <?=$SECTION['ACTIVE']?>"><?=$SECTION['NAME']?></a>
                    </li>
                <? endforeach;?>
            </ul>
            <div class="big-block">
                <div class="big-block__content">
                    ...
                    <? $GLOBALS['sectionFilter']['SECTION_ID'] = $currSectionID;?>
